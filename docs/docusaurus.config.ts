...
const config: Config = {
  ...
  organizationName: 'therizwan', // Usually your GitHub org/user name.
  projectName: 'llm-guard', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} LLM Guard. Built with Docusaurus.`,
    },
    prism: {
